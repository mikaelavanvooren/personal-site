  		...
  		<Container fluid id={"imgContainer"}>
  			<Row>
  				<Col >
					...
					<Col sm={6} xs={12}>
						<div id={"aboutBio"}><h3><b>Hi, my name is Mikaela Van Vooren.</b></h3> <br/>
			...
			<Container fluid id={"infoContainer"}>
			  <div id={"problems"}>problems</div>
			  	<Container className="aboutText">
					  <div><br/><br/>Some of the problems I'm most passionate about are finding ways to support those with <b>mental heath struggles</b>, working on new technology to further <b>environmental sustainability</b> and developing new techniques to get kids excited about <b>STEAM subjects in school</b>. <br/><br/>I'm excited about where we will lead the future with what we are doing now to drive it forward!
					  <br/><br/><br/>
			  		</div>
			  	</Container>
				</Container>
